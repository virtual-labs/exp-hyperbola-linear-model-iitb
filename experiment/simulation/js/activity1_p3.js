function activity1_p3() {
    ...
    <p class='fs-16px'><span> $$ Required \\ Equations => b_0\\Sigma {(X')^2} + a_0\\Sigma {X'} = \\ \\Sigma {X'Y'}  and \\ \\ b_0\\Sigma {X'} + a_0n = \\ \\Sigma {Y'}  $$</span></p>
    <p class='fs-16px'><span>$$ \\Sigma {X'} = ${sigma_xi}, \\ \\ \\Sigma {Y'} = ${sigma_yi}, \\ \\ \\Sigma {X'^2} = ${sigma_xi_2}, \\ \\ \\Sigma {X'Y'} = ${sigma_xi_yi} $$</span></p>
    <hr>
